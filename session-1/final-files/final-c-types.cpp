...
int main()
{
    ...
    // Interesting values to compare: 0, 1, 2, 10, 32767, 2147483647, 9223372036854775807, 1e50
    
    signed short signed_num_1 = 0;
    signed short signed_num_2 = 0;
    unsigned short unsigned_num_1 = 0;
    unsigned short unsigned_num_2 = 0;
    // Interesting values to compare: 0, 1, 2, -1, -2, 32767, -32768
    
    float floating_num_1 = 0.0;
    float floating_num_2 = 0.0;
    float floating_num_3 = 0.0;
    // Interesting values to compare: 0, 1, -1, 1e10, 1e-10, 1.0 / 0.0, (1.0 / 0.0) - (1.0 / 0.0), 1e99, 1e-99
